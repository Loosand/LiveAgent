...
export function AppBootShell(props: { loadingLabel: string }) {
  return (
    ...
    >
      <aside className="flex w-[272px] shrink-0 flex-col border-r border-border bg-[hsl(var(--sidebar-bg))] px-3 py-4">
        ...
        <div className="space-y-3 px-2" aria-hidden>
          ...
          <div className="h-8 rounded-lg bg-muted-foreground/5" />
          <div className="h-8 rounded-lg bg-muted-foreground/5" />
          <div className="h-8 rounded-lg bg-muted-foreground/5" />
        </div>
      </aside>
