...
export function AppUpdateButton({
  ...
  return (
    <Button
      ...
      className={cn(
        iconOnly
          ? "group/update relative h-6 w-6 shrink-0 gap-0 overflow-hidden rounded-full bg-ui-4096ff px-0 text-11px font-medium leading-none text-white shadow-none transition-[width,background-color] duration-150 hover:w-10 hover:bg-ui-1677ff hover:text-white active:bg-ui-0958d9"
