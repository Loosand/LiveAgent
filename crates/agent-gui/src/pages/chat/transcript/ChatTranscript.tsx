      ...
      >
        <div
          className={cn(
            ...
            "mx-auto w-full max-w-[calc(var(--chat-transcript-content-width,768px)-2.5rem)] px-4 py-4 [overflow-anchor:none]",
      ...
      {renderedContextMenu && transcriptContextMenuPosition
        ? createPortal(
            <div
              ...
              role="menu"
              className={cn(
                "editor-context-menu layer-popover fixed w-max min-w-38 max-w-[calc(100vw-1.5rem)] select-none overflow-hidden rounded-lg border border-border bg-popover p-2 text-popover-foreground shadow-overlay",
