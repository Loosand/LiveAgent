...
export function LoginPage({ token, error, isSubmitting, onTokenChange, onSubmit }: LoginPageProps) {
  ...
  return (
    <main className="login-shell">
      ...
      <div
        className="login-backdrop-orb w-500px h-500px top-minus-120px left-minus-80px bg-hsl-210-100-88-0p5 animate-login-backdrop-orb-1 dark:bg-hsl-210-80-30-0p2 max-820:w-300px max-820:h-300px"
        aria-hidden="true"
      />
      <div
        className="login-backdrop-orb w-400px h-400px bottom-minus-100px right-minus-60px bg-hsl-250-70-88-0p4 animate-login-backdrop-orb-2 dark:bg-hsl-250-60-30-0p15 max-820:w-250px max-820:h-250px"
        aria-hidden="true"
      />
          ...
          <div className="w-full max-w-360px max-1080:max-w-full">
            <div className="mb-28px max-640:mb-20px max-380:mb-16px">
              <div className="flex items-center gap-10px">
                <div className="shrink-0 flex items-center justify-center w-34px h-34px rounded-10px text-muted-foreground bg-muted/60 border border-solid border-hsl-0-0-0-0p04 dark:bg-hsl-0-0-100-0p06 dark:border-hsl-0-0-100-0p06 max-820:w-30px max-820:h-30px max-820:rounded-9px max-380:w-28px max-380:h-28px max-380:rounded-8px">
            ...
            >
              {isSubmitting ? (
                <span className="inline-block w-18px h-18px border-2 border-solid border-primary-foreground/30 border-t-primary-foreground rounded-half animate-login-btn-loading" />
              ) : (
                <>
                  进入 Gateway
