...
function CheckpointCard(props: {
  ...
  return (
    <div className="flex max-w-full items-start gap-3 w-full max-640:block">
      <div className="mt-0.5 h-6 w-6 shrink-0 max-640:hidden" aria-hidden="true" />
        ...
        if (row.kind === "user") {
          return (
            <article
              ...
              data-index={virtualRow.index}
              ref={transcriptVirtualizer.measureElement}
              className="gateway-transcript-row absolute left-0 right-0 top-0 justify-end!"
              style={{ transform: `translateY(${virtualRow.start}px)` }}
            >
        ...
        if (row.kind === "checkpoint") {
          return (
            <article
              ...
              data-index={virtualRow.index}
              ref={transcriptVirtualizer.measureElement}
              className="gateway-transcript-row absolute left-0 right-0 top-0 w-full"
              style={{ transform: `translateY(${virtualRow.start}px)` }}
            >
