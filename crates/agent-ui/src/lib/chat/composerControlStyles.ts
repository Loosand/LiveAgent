...
export const COMPOSER_CONTROL_TRIGGER_CLASS =
  "composer-model-trigger inline-flex h-8 min-w-8 max-w-[10.5rem] shrink-0 items-center justify-start gap-2 overflow-hidden rounded-full px-2 text-xs font-medium text-foreground shadow-none transition-colors hover:bg-muted/60 focus-visible:bg-muted/60 disabled:opacity-40 @max-[480px]:w-8 @max-[480px]:justify-center @max-[480px]:gap-0 @max-[480px]:px-0";
