export const ZH_CN_COMMON_TRANSLATIONS = {
  ...
  "chat.time.seconds": "秒",
  "chat.work.running": "正在工作",
  "chat.work.activity": "工作过程",
  ...
  "chat.tool.activity.list.running": "正在列出",
  "chat.tool.activity.list.done": "已列出",
  "chat.tool.activity.search.running": "正在搜索",
  "chat.tool.activity.search.done": "已搜索",
  "chat.tool.activity.read.running": "正在读取",
  "chat.tool.activity.read.done": "已读取",
  "chat.tool.activity.command.running": "正在运行命令",
  "chat.tool.activity.command.done": "已运行命令",
  "chat.tool.activity.write.running": "正在写入",
  "chat.tool.activity.write.done": "已写入",
  "chat.tool.activity.write.created": "已创建",
  "chat.tool.activity.edit.running": "正在编辑",
  "chat.tool.activity.edit.done": "已编辑",
