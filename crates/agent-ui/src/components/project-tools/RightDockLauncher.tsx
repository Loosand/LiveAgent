  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col items-center justify-center gap-4 px-4 py-6">
      <div className="flex flex-col items-center gap-1">
        <h3 className="text-base font-medium text-foreground">{t("projectTools.getStarted")}</h3>
      ...
      <div className="flex w-full max-w-xs flex-col gap-2">
        {tools.map((tool) => (
          <button
            ...
            className="group flex items-center gap-3 rounded-lg border border-border bg-background px-4 py-3 text-left text-xs text-foreground transition-all hover:border-input hover:bg-muted/60 hover:shadow-control disabled:pointer-events-none disabled:opacity-50"
          >
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-muted/80 text-muted-foreground transition-colors group-hover:bg-muted group-hover:text-foreground">
              {tool.icon}
            </div>
