...
const TUNNEL_INPUT_CLASS =
  "h-8 min-w-0 rounded-lg border-border bg-background/80 text-xs placeholder:text-xs transition-[border-color,box-shadow,background-color] focus-visible:border-input focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-muted-foreground/20 focus-visible:ring-offset-0";
...
function TtlSegmented({
  ...
  const { t } = useLocale();
  return (
    <div className="grid min-w-0 grid-cols-4 gap-0.5 rounded-lg bg-muted/80 p-0.5">
      {TUNNEL_TTL_OPTIONS.map((option) => {
        ...
        return (
          <button
            ...
            disabled={disabled}
            className={cn(
              "h-7 min-w-0 truncate rounded-lg px-1 text-xs text-muted-foreground transition-all duration-200 hover:text-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
              active && "bg-background font-medium text-foreground shadow-control",
            )}
          >
...
function HealthBadge({
  ...
  return (
    <span
      title={title}
      className={cn(
        "inline-flex min-w-0 items-center gap-2 rounded-full border px-2 py-0.5 text-xs font-medium",
        status === "ok"
...
const TunnelRow = memo(function TunnelRow(props: TunnelRowProps) {
  ...
  return (
    <div className="min-w-0 overflow-hidden rounded-2xl border border-border bg-background/80 shadow-control backdrop-blur-xl transition-shadow duration-200 hover:shadow-control">
      <div className="flex min-w-0 items-center gap-2 px-3 pt-2">
        ...
        <span
          className={cn(
            "inline-flex shrink-0 items-center gap-2 rounded-full border px-2 py-0.5 text-xs font-medium",
            offline
      ...
      {isEditing ? (
        <>
          <div className="grid min-w-0 gap-2 px-3 pb-1 pt-2">
            <div className="grid gap-2">
              ...
              />
              {editTargetValidationKey ? (
                <div className="flex items-start gap-1 text-xs leading-relaxed text-warning">
            ...
            <div className="grid gap-2">
              ...
              <button
                ...
                disabled={!mutationsEnabled || updating}
                className={cn(
                  "flex h-7 min-w-0 items-center justify-center truncate rounded-lg bg-muted/80 px-2 text-xs text-muted-foreground transition-all duration-200 hover:text-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
                  editTtlSeconds === "keep" &&
                    "bg-background font-medium text-foreground shadow-control ring-1 ring-border/60",
                )}
              >
          ...
          <div className="mt-2 flex items-center justify-end gap-2 border-t border-border px-3 py-2">
            <Button
              type="button"
              variant="ghost"
              size="sm"
        ...
        <>
          <button
            ...
            className="mx-3 mt-2 flex w-[calc(100%-1.5rem)] min-w-0 items-center gap-2 rounded-lg border border-border bg-muted/40 px-2 py-2 text-left transition-colors duration-150 hover:border-input hover:bg-muted/80 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
          >
            ...
            {copied ? (
              ...
              <Copy className="h-3.5 w-3.5 shrink-0 text-muted-foreground/80" />
            )}
          </button>
          <div
            className="mt-2 flex min-w-0 items-center gap-1 px-3 text-xs text-muted-foreground"
          ...
          <div className="mx-3 mt-2 flex min-w-0 items-center gap-1">
            <div
              ...
              className={cn(
                "flex h-6 min-w-0 items-center gap-1 rounded-lg border px-2 text-2xs font-medium",
                localStatus === "ok"
                  ? "border-success/20 bg-success/10 text-success"
                  : localStatus === "failed"
                    ? "border-destructive/20 bg-destructive/10 text-destructive"
          ...
          {rowError ? (
            <div className="mx-3 mt-2 rounded-lg border border-destructive/20 bg-destructive/10 px-2 py-2 text-xs leading-relaxed text-destructive">
              {rowError}
            </div>
          ) : null}
          <div className="mt-2 flex items-center justify-between gap-2 border-t border-border py-1 pl-3 pr-2">
              ...
              {scope === "global" ? (
                tunnelProjectPathKey ? (
                  <span
                    ...
                    className="min-w-0 max-w-[120px] truncate rounded-full bg-muted/80 px-2 py-px text-2xs"
                  >
                    {projectNameFromPathKey(tunnelProjectPathKey) ||
                      t("projectTools.tunnelScopeProjectBadge")}
                  </span>
                ) : (
                  <span className="shrink-0 rounded-full bg-muted/80 px-2 py-px text-2xs">
...
export function LocalTunnelPanel({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-gradient-to-b from-muted/40 via-muted/20 to-background">
      <div className="shrink-0 border-b border-border bg-background/80 px-4 pb-3 pt-4 backdrop-blur-xl">
        <div className="flex items-center gap-2">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl border border-border bg-background/80 text-foreground/80 shadow-none dark:shadow-none">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-3 py-3">
        {disabledMessage ? (
          <div className="mb-3 flex items-start gap-2 rounded-2xl border border-warning/40 bg-warning/10 px-3 py-2 text-xs leading-relaxed text-warning dark:border-warning/20">
          ...
          >
            <div className="min-h-0 overflow-hidden">
              <section
                ...
                className={cn(
                  "overflow-hidden rounded-2xl border border-border bg-background/80 shadow-control backdrop-blur-xl transition-[border-color,background-color,box-shadow] duration-200 ease-out motion-reduce:transition-none",
              ...
              >
                ...
                >
                  <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-lg bg-muted/80 text-muted-foreground">
                ...
                >
                  <div className="min-h-0 overflow-hidden">
                    <form
                      ...
                      className={cn(
                        "grid min-w-0 gap-3 border-t border-border px-3 pb-3 pt-3 transition-transform duration-200 ease-out motion-reduce:transition-none",
        ...
        {createError ? (
          <div className="mb-3 rounded-2xl border border-destructive/20 bg-destructive/10 px-3 py-2 text-xs leading-relaxed text-destructive">
            {createError}
          </div>
        ) : null}
        ...
        <div>
          <div className="flex items-center justify-between px-1 pb-2">
            ...
            {sortedTunnels.length > 0 ? (
              <span className="rounded-full bg-muted/80 px-2 py-px text-xs tabular-nums text-muted-foreground">
                {sortedTunnels.length}
              </span>
            ) : null}
          </div>
          {listError ? (
            <div className="mb-2 rounded-2xl border border-destructive/20 bg-destructive/10 px-3 py-2 text-xs leading-relaxed text-destructive">
              {listError}
            </div>
          ) : null}
          {loading && sortedTunnels.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center gap-2 rounded-2xl border border-dashed border-border bg-background/40 px-4 py-8 text-center">
