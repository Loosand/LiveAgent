  ...
  const renderDragHandle = useCallback(
    (itemId: string, label: string) => (
      <button
        ...
        className={cn(
          "flex h-8 w-5 shrink-0 items-center justify-center rounded-sm text-muted-foreground/60 transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring",
          enabled
