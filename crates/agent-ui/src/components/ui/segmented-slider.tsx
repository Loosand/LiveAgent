  ...
  return (
    ...
    >
      ...
      <span
        ...
        className="absolute inset-y-0.5 left-0.5 rounded-lg bg-background shadow-control transition-transform duration-200 ease-out"
        style={{
      ...
      {options.map((option) => (
        <label
          key={option.value}
          className={cn(
            "relative inline-flex min-w-0 items-center justify-center whitespace-nowrap rounded-lg px-2 text-xs font-medium leading-none transition-colors",
