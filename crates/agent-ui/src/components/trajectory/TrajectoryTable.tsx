...
export function TrajectoryTable(props: {
  ...
  if (items.length === 0) {
    return (
      <div className="flex min-w-0 flex-1 items-center justify-center p-6 text-xs text-muted-foreground">
...
function TurnHeader(props: {
  ...
  return (
    <button
      ...
      className={cn(
        "flex h-[30px] w-full items-center gap-1 bg-muted/40 px-3 text-xs text-muted-foreground",
