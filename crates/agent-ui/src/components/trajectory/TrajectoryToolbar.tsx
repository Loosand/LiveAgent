...
export function TrajectoryToolbar(props: {
  ...
  return (
    <div
      ...
      className="flex shrink-0 items-center gap-1 border-b border-border px-3 py-2 @max-[520px]:flex-wrap @max-[520px]:gap-y-2 @max-[520px]:px-2"
    >
      <ToolbarButton
      ...
      <div className="ml-auto flex min-w-0 items-center gap-2 rounded-lg border border-border px-2 py-1 focus-within:border-ring @max-[520px]:order-last @max-[520px]:ml-0 @max-[520px]:w-full">
...
function ToolbarButton(props: {
  ...
  return (
    <button
      ...
      className={cn(
        "flex items-center gap-1 rounded-lg px-2 py-1 text-xs transition-colors @max-[520px]:flex-1 @max-[520px]:justify-center",
