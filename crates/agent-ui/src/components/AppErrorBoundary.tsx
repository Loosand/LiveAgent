  ...
  render() {
    ...
    return (
      <div className="flex h-full w-full flex-col items-center justify-center gap-4 bg-background p-8 text-center">
        ...
        <div className="max-h-40 max-w-xl overflow-auto whitespace-pre-wrap rounded-lg border border-border bg-muted/40 p-3 text-left font-mono text-xs text-muted-foreground">
          {error.message}
