    ...
    >
      ...
      >
        ...
        <DialogBody className="flex overflow-hidden p-0 max-[720px]:flex-col">
          <nav
            className="flex w-[188px] shrink-0 flex-col gap-1 border-r bg-muted/40 p-2 max-[720px]:w-full max-[720px]:flex-row max-[720px]:overflow-x-auto max-[720px]:border-b max-[720px]:border-r-0 max-[720px]:px-2 max-[720px]:py-2"
