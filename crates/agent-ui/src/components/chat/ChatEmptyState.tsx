...
export function ChatEmptyState({
  ...
  return (
    <div className="relative flex w-full flex-col items-center">
      <div className="relative mb-5 flex h-14 w-14 items-center justify-center animate-chat-hero-logo-enter will-change-[transform,opacity] motion-reduce:animate-none">
        {/* Idle float lives on an inner wrapper so its transform never fights
            the entrance animation on the outer node. */}
        <div className="relative flex h-full w-full items-center justify-center animate-chat-hero-logo-float motion-reduce:animate-none">
          <div
            aria-hidden="true"
      ...
      {variant === "no-models" ? (
        <>
          <div className="chat-hero-title-enter mb-1.5 text-center text-scaled-22px font-semibold leading-7 tracking-tight text-foreground">
            {t("chat.welcome")}
          </div>
        ...
        <>
          <div className="chat-hero-title-enter whitespace-nowrap text-center text-scaled-20px font-semibold leading-7 tracking-tight text-foreground">
