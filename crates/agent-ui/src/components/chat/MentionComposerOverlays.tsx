  ...
  return createPortal(
    ...
    >
      ...
      <div
        ...
        className="relative flex flex-col overflow-y-auto px-2 pb-2 web:[scrollbar-color:var(--gateway-scrollbar-thumb)_transparent] web:[&::-webkit-scrollbar]:w-8px web:[&::-webkit-scrollbar]:h-8px"
      >
        {isLoading && (
